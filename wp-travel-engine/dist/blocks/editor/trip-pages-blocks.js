...
`,ia=({color:e,title:t,children:n,interactive:o,placement:i="left"})=>(0,r.createElement)(oa,{className:"cw__color-picker-trigger",color:e},(0,r.createElement)(vi,{content:n,interactive:o,placement:i},(0,r.createElement)(mi,{title:t},(0,r.createElement)("span",{tabIndex:0,className:"cw__color-picker-color-block"},(0,r.createElement)("span",{className:"cw__color-picker-color-block-inner"}))))),aa=ir.header`
  padding: 5px;
  border: 1px solid var(--cw__border-color);
  border-radius: var(--cw__border-radius);
  margin: 0 -4px 13px;
...
`,la=({colorPalette:e,value:t,title:n,interactive:o,onChange:i,placement:a,...c})=>{let s=t;if(t?.includes("var(")){const e=t.replace(/var[()]/g,"").replace(/[)]/g,"");s=getComputedStyle(document.body).getPropertyValue(e)}return(0,r.createElement)(ia,{color:t,title:n,interactive:o,placement:a},e&&(0,r.createElement)(aa,null,(0,r.createElement)(l.ColorPalette,{colors:e,value:s,clearable:!1,disableCustomColors:!0,onChange:t=>{const n=e.find((e=>e.color===t))?.slug;i(`var(${"--wp--preset--color--"+n})`)},...c})),(0,r.createElement)(l.ColorPicker,{color:s,enableAlpha:!0,defaultValue:"#000",onChange:i,...c}))},ca=e=>Si(la)(e),sa=ir.div`
  display: flex;
  flex-wrap: wrap;
  gap: 4px;
`,da=({colors:e,value:t,onChange:n,...o})=>(0,r.createElement)(sa,null,e?.map((({title:e,name:i,colorPalette:a},l)=>(0,r.createElement)(ca,{key:l,value:t[i],title:e,colorPalette:a,onChange:e=>n({...t,[i]:e}),...o})))),ua=e=>Si(da)(e),pa=(ir.div`
  padding: 10px;
  border: 1px solid var(--cw__border-color);
  border-radius: var(--cw__border-radius);
  display: flex;
...
`,ha=[{name:"top",label:"Top"},{name:"right",label:"Right"},{name:"bottom",label:"Bottom"},{name:"left",label:"Left"}],ga=(e,t)=>{let n={};return ha.map((({name:r})=>{const o="auto"!==t[r];n={...n,[r]:o?e:t[r]}})),n},ma=[{unit:"px",min:0,max:1e3},{unit:"em",min:0,max:20},{unit:"rem",min:0,max:20},{unit:"%",min:0,max:100},{unit:"pt",min:0,max:100}],va=({label:e,value:t,...n})=>{const o="auto"!=t;return(0,r.createElement)(pa,{className:"cw__spacing-input-wrapper"},(0,r.createElement)("span",{className:"cw__spacing-input"},(0,r.createElement)("input",{readOnly:!o,type:o?"number":"text",value:t,...n})),e&&(0,r.createElement)("span",{className:"label"},e))},ba=({onChange:e,value:t,units:n,...o})=>{const[i,a]=(0,hi.useState)(!0);n=(0,Gi.isBoolean)(n)?ma:n;const l=Object.values(t).find((e=>""!==e&&"auto"!==e))||"",[c="px"]=Ji(l),s=n?.find((e=>e.unit===c)),d=s?.max||1e3,u=s?.min||0,p=Object.values(t).find((e=>""!==e&&"auto"!==e))||0+c,f=n=>{const r=n.target.value,o=n.target.name;if("number"===n.target.type){const n=""!==r?r>=d?d:r<=u?u:r:r;e(i?{...t,...ga(n+c,t)}:{...t,[o]:n+c})}};return n=n?.map((e=>e.unit)),(0,r.createElement)(fa,{className:"cw__spacing-group"},ha.map((({name:e,label:n})=>{let i=t[e];if(Ji(t[e]).length>0){var a;const[,n]=(null!==(a=t[e])&&void 0!==a?a:"")?.match(Qi)||[];i=n}return(0,r.createElement)(va,{key:e,label:n,name:e,onChange:f,value:i,...o})})),(0,r.createElement)("div",{className:"cw__spacing-button-wrapper"},(0,r.createElement)("button",{type:"button",className:"cw__spacing-button-link-button"+(i?" active":""),onClick:()=>(a(!i),void e({...t,...ga(p,t)}))},yi.link),(0,r.createElement)(xi,{units:n,value:c,onChange:n=>(n=>{let r={};Object.entries(t).map((([e,t="0px"])=>{var o;const[,i]=null!==(o=t?.match(/(\d+)/))&&void 0!==o?o:[];""!==t&&(r={...r,[e]:i+n})})),e({...t,...r})})(n)})))},wa=e=>Si(ba)(e),xa=(ir.div`
    .components-button {
        min-height: 43px;
        display: flex;
        align-items: center;
...
`),ya=({value:e,min:t,max:n,onChange:o,step:i,...a})=>{const l=i||1;return(0,r.createElement)(xa,{className:"cw__input-number-wrapper"},(0,r.createElement)("button",{disabled:t>=e,type:"button",onClick:()=>{o(+e-l)}},yi.minus),(0,r.createElement)("input",{type:"number",value:+e,onChange:e=>o(e.target.value),min:t,max:n,...a}),(0,r.createElement)("button",{disabled:n<=e,type:"button",onClick:()=>{o(+e+l)}},yi.plus))},Ca=e=>Si(ya)({...e,direction:"horizontal"}),_a=ir.div`
    display: inline-flex;
    align-items: center;
    gap: 8px;
`,ka=({value:e,onChange:t})=>{const{width:n,style:o}=e;return(0,r.createElement)(r.Fragment,null,(0,r.createElement)(Ca,{label:"Border Width",direction:"horizontal",value:n,onChange:n=>t({...e,width:n}),min:0,isChildren:!0}),(0,r.createElement)(Ni,{label:"Border Style",options:[{value:"none",label:"None",icon:yi.none},{value:"solid",label:"Solid",icon:yi.minus},{value:"dashed",label:"Dash",icon:yi.dashed},{value:"double",label:"Double",icon:yi.menu},{value:"dotted",label:"Dot",icon:yi.ellipsis}],value:o,onChange:n=>t({...e,style:n}),isChildren:!0}))},Ea=({colorPalette:e,changed:t,value:n,onChange:o,...i})=>{const{color:a}=n;return(0,r.createElement)(_a,null,(0,r.createElement)(ca,{colorPalette:e,title:"Border Color",value:a,onChange:e=>o({...n,color:e}),...i}),(0,r.createElement)(vi,{content:(0,r.createElement)(ka,{value:n,onChange:o,...i})},(0,r.createElement)(_i,{changed:t})))},Oa=e=>Si(Ea)({...e,direction:"horizontal"}),Ma=ir.div`
...
`),Ba=e=>(0,r.createElement)(Pa,null,(0,r.createElement)(l.FormTokenField,{...e})),ja=e=>Si(Ba)(e),Va=(ir.div`
    margin-bottom: 16px;
